...
const Form: React.FC<FormProps> = ({
  ...
  <form className="p-4 bg-gray-100 rounded shadow-md">
    <InputField label="決定額" value={totalAmount} onChange={(value) => onTotalAmountChange(Number(value))} inputType="number" />
    <InputField label="税抜額" value={beforeTaxAmount} onChange={(value) => onBeforeTaxAmountChange(Number(value))} inputType="number" />
    <Dropdown
      label="消費税率"
